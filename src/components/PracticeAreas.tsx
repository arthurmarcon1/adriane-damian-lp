  ...
  return (
    <section id="atuacao" className="bg-bg-secondary py-20 md:py-32">
      <div className="max-w-7xl mx-auto px-8 md:px-16">
        ...
        <h2 className="font-serif font-normal text-green-deep text-4xl md:text-5xl tracking-tight leading-tight max-w-[700px] mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-px bg-rule-line">
          {areas.map((a) => (
            <article key={a.n} className="bg-bg-secondary p-10 md:p-12">
              <div className="font-serif font-normal text-5xl text-gold-accent mb-8 leading-none">
                {a.n}
              </div>
              <hr className="w-[30px] h-px border-0 border-t border-green-deep mb-8" />
              <h3 className="font-serif font-medium text-2xl md:text-3xl text-green-deep mb-4">
                {a.title}
              </h3>
